...
public class CompletedRecyclerViewAdapter  extends RecyclerView.Adapter<CompletedRecyclerViewAdapter.ViewHolder> {
    ...
    public CompletedRecyclerViewAdapter(List<SportFan> myDataset) {
        mDataset = myDataset;
    }

    // Create new views (invoked by the layout manager)
    @Override
    public CompletedRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.completed_item, parent, false);
